...
public class AddGameRequest {
    private static final Logger LOGGER = LoggerFactory.getLogger(AddGameRequest.class);

    private final InitialContext context;

    public AddGameRequest() throws NamingException {
    ...
    public void run() throws JMSException, NamingException, InterruptedException {
        ...
        try {
            ...
            requestProducer = session.createProducer((Destination) context.lookup("addGame"));

            Message request = session.createTextMessage("{\"homeTeam\": \"Aston Villa\", \"awayTeam\": \"Birmingham City\"}");
    ...
    public static void main(String[] args) throws JMSException, NamingException, InterruptedException {
        AddGameRequest client = new AddGameRequest();
        client.run();
    }
}