...
public class GetScoreRequest {
    private static final Logger LOGGER = LoggerFactory.getLogger(GetScoreRequest.class);

    private final InitialContext context;

    public GetScoreRequest() throws NamingException {
    ...
    public void run() throws JMSException, NamingException, InterruptedException {
        ...
        try {
            ...
            requestProducer = session.createProducer((Destination) context.lookup("getScore"));
    ...
    public static void main(String[] args) throws JMSException, NamingException, InterruptedException {
        GetScoreRequest client = new GetScoreRequest();
        client.run();
    }
}