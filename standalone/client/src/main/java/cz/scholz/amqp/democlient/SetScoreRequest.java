...
public class SetScoreRequest {
    private static final Logger LOGGER = LoggerFactory.getLogger(SetScoreRequest.class);

    private final InitialContext context;

    public SetScoreRequest() throws NamingException {
    ...
    public void run() throws JMSException, NamingException, InterruptedException {
        ...
        try {
            ...
            requestProducer = session.createProducer((Destination) context.lookup("setScore"));

            Message request = session.createTextMessage("{\"homeTeam\": \"Aston Villa\", \"awayTeam\": \"Birmingham City\", \"homeTeamGoals\": 4, \"awayTeamGoals\": 0}");
            ...
            LOGGER.info("Status = {}", response.getIntProperty("status"));
    ...
    public static void main(String[] args) throws JMSException, NamingException, InterruptedException {
        SetScoreRequest client = new SetScoreRequest();
        client.run();
    }
}